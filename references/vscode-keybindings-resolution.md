...
This document explains how Visual Studio Code resolves keybindings when multiple rules, extensions, or `when` clauses compete for the same key. It is designed to be a definitive reference for extension authors and advanced users.
