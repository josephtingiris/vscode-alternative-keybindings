...
agent: agent
---
Ensure #file:../../references/keybindings.json is kept consistent with the keybinding conventions and context key usages defined in .github/agents/keybindings-expert.agent.md and .github/instructions/keybindings-conventions.instructions.md.
